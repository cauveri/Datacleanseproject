...
Objective
Utilize the given data set, perform various data cleaning steps, and prepare tidy data set as directed
...
Resultant Tidy Set variables and calculations
Subject	
Activityname	
...
The result is saved as average_by_act_subject_sensor.txt, a 180x68 data frame,  the first column contains subject IDs, the second column is descriptive activity names, and then the averages for each of the 66 attributes are in columns 3...68. Have 30 subjects, 6 activities, thus 180 rows set with the averages.